...
<<<<<<<< HEAD:src/AppForSEII2526.API/Migrations/20251210201418_CreateIdentitySchema.Designer.cs
    [Migration("20251210201418_CreateIdentitySchema")]
========
    [Migration("20251211143700_CreateIdentitySchema")]
>>>>>>>> origin/development:src/AppForSEII2526.API/Migrations/20251211143700_CreateIdentitySchema.Designer.cs
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppForSEII2526.API.Models.Incident", b =>
                {
                    ...
                    b.Property<DateTime>("DateOdIdentification")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AppForSEII2526.API.Models.IncidentItem", b =>
                {
                    ...
                    b.Property<int>("IncidentPriority")
                        .HasColumnType("int");

                    b.Property<string>("ItemForExerciseLocation")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("IncidentId", "ItemId");

                    b.HasIndex("ItemForExerciseLocation");
            ...
            modelBuilder.Entity("AppForSEII2526.API.Models.Purchase", b =>
                {
                    ...
                    b.Property<decimal>("Total_prices")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("AppForSEII2526.API.Models.IncidentItem", b =>
                {
                    b.HasOne("AppForSEII2526.API.Models.Incident", "Incident")
                        .WithMany("IncidentItems")
                        .HasForeignKey("IncidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppForSEII2526.API.Models.ItemForExercise", "ItemForExercise")
                        .WithMany("IncidentItems")
                        .HasForeignKey("ItemForExerciseLocation")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Incident");

                    b.Navigation("ItemForExercise");
                });
