...
INSERT INTO [dbo].[AspNetUsers] 
    ...
    ([Id], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount], [Name], [Surname])
...
VALUES
    ...
    (N'1001', -- Id único
     ...
     N'AQAAAAIAAYagAAAAEBb0aMfbI6rZK+N7+L9lN8nHiyhzml+P3x/PKH1uUpTqvLh1D8KN/7nXZk8oYh+dA==', -- PasswordHash para 'Password123!'

     N'8KH7M6JLQPZ5G3YQ34Q7OQKJYH6HMXRI', -- SecurityStamp

     N'7d63f8fa-3d2b-4c19-8f8e-9b8e1a7aeb11', -- ConcurrencyStamp
